...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	ДобавитьКоманду(ТаблицаКоманд, "КомандаПример фоновое", "Синхронизация1C_ClickHouseНаСервере_КомандаПример" , "ВызовСерверногоМетода");
...
Функция ПолучитьСхемуКомпановкиДанныхПоЗапросу(ТекстЗапроса)
	Возврат СоздатьСхемуКомпоновкиДанных(ТекстЗапроса);	
КонецФункции
