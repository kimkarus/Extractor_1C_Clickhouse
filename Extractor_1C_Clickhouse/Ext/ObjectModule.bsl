...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	Автор = Символы.ПС + "by Ilya Kosarev (kimkarus)" + Символы.ПС + "https://kimkarus.ru" + Символы.ПС + "Авторское право на основе свидетельства № 2024668582 от 08.08.2024 от ФИПС (Роспатент)"; 
		
	РегистрационныеДанные = Новый Структура();
	РегистрационныеДанные.Вставить("Вид", "ДополнительнаяОбработка");
	РегистрационныеДанные.Вставить("Наименование", Синоним);
	РегистрационныеДанные.Вставить("Версия", "1.1.3");
