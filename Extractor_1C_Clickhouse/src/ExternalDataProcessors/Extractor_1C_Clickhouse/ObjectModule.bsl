...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	РегистрационныеДанные.Вставить("Версия", "1.3.8.4");
...
//<<%%>> ilya@kimkarus.ru @kimkarus_service_bot kimkarus.ru # Ilya Kosarev 10-09-2025 9:3 start
Процедура ВыполнитьОжиданиеЦиклСекунд(ВремяОжидания)
	...
	КонецЦикла;
КонецПроцедуры
//<<%%>> ilya@kimkarus.ru @kimkarus_service_bot kimkarus.ru # Ilya Kosarev 10-09-2025 9:3 end
